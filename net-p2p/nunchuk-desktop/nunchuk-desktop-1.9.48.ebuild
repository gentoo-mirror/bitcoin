...
MyPV="$(ver_cut 1-3)"
COMMIT_HASH="387321b8ea0c9325dfc1def6c0f972fccd6c3631"
...
LICENSE="GPL-3"
SLOT="0"
if [[ "${PV}" != *_pre* && "${PV}" != *_rc* ]] ; then
	KEYWORDS="~amd64 ~arm ~arm64 ~x86"
fi

RDEPEND="
	>=dev-cpp/libnunchuk-0.1.0_pre20250620:=
	dev-libs/boost:=
	>=dev-libs/olm-3.1.3:=
