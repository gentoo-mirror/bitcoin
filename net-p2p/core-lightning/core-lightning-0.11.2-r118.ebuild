...
#	769efe8d5456a27707c086956d3bd19ab6417439	# tests: massively speed up our wait for enormous feerates
	...
	9685c1adafd0e3feaf8813a68acff77176738da2:strip=tests/:scrub-stamps	# lightningd: remove getsharedsecret.
...
#	c83c1521ced54a5a7c72ab0033576c45fc234d18	# memleak: throw away things when we're done with them
	6e9af1ef3ec51f93417e375b2f52144f3c5e78cb:strip=plugins/bkpr/	# bkpr: cleanup csv_safe_str
...
#	98bfd23fff7d2be8096413209c4ff84a4e5739f3	# pytest: test_channel_resurrection now succeeds
	4b9cb7eb760849e4166307c2658f28379f60edd0:scrub-stamps:resolve-conflicts	# doc: remove unused offerout schema.
...
#	4f3f3deab621a0890d61455be7ed66500e977b71	# fix: partial fix lnprototest runner
	...
	06b9009dd8d2de7deaed8adee345517f8f393297:strip=tests/	# lightningd: remove deprecated behavior where checkmessage would fail quietly.
...
#	48c334dc81085f2518186328c81248812b9092b5	# build(deps): bump werkzeug from 2.2.2 to 2.2.3
	...
	91a9cf351290ecccd4a75925c59e22e334798bc6:strip=tests/	# hsmd: capability addition: ability to check pubkeys.
	...
	df085a8a875e1a02f93bd823ef2cb915563f21dd:resolve-conflicts=0.12.1-	# wallet/db: don't use migration_context.
...
#	d818614aa9e67419c03760fa9f05245da255b281	# plugins/sql: recurse correctly into complex objects during processing.
	e75cf2e7fbc143a927f404f70a4c254bd5a4129e:strip='\(doc/lightning-sql\b\|tests/\)':scrub-stamps	# listpeerchannels: add channel_type, both in hex and as array of names.
	89f91b9bb4174b258db237b3dfd78bf3cd3791c0:strip=tests/:resolve-conflicts	# lightningd: add listclosedchannels command.
#	b8519a6a1a4cf90e2c9b6d93499e112a1a7041e5	# plugins/sql: add listclosedchannels
...
#	3e83bed46097f8c7b9a7d453db653c715c3e0855	# pyln-testing: adapt wait_for_onchaind_broadcast function for when onchaind uses lightningd for broadcast.
	...
	9d5dfa7bddb0fda9335c1b1d3de05c0b0ae42f04:strip=tests/	# onchaind: use lightningd for spending our unilateral "to us" output.
	80cd6f0afe75968e4dab7b3a0e720fca04f1e3c4:resolve-conflicts	# lightningd: remember depth of closing transaction.
	...
	a9dfec0e713053eb3b35bc82f3df1d08170bb969:strip=tests/	# onchaind: use lightningd to sign and broadcast htlc_success transactions.
	868fa8ae814b990b664b1e1b89811b04e12c88d8:strip=tests/	# onchaind: use lightningd to sign and broadcast htlc spending txs.
	5bdd532e708265afb92866176d1e9714bcfc28c1:strip=tests/	# onchaind: use lightningd to sign and broadcast htlc_timeout transactions.
...
#	a3ebc1bac49cc8cf022525bbad5ff75d1638c673	# lightningd: update comments now channel-type is merged.
	...
	d4ffc756916b16d19cca6522b6f8ec422f32f24b:strip=tests/	# Makefile: update to latest BOLT text.
...
#	ca80dee5145ff9240aa6b4e342e14332bec9973b	# doc: add section about improving fuzzing corpora
	...
	cdb85d561898c424105930ff08a695d0982ea033:strip=tests/	# lightningd: handle fees as blockcount + range.
	64b1ddd761de30152154714433974b72bfb7f278:strip=tests/:scrub-stamps:resolve-conflicts	# lightningd: clean up feerate handling, deprecate old terms.
	c46473e61549e6d927914c8496dfdabea073badf:strip=tests/	# lightningd: allow "NNblocks" and "minimum" as feerates.
	9e2d4240b1635770ff25cbf21c7fb2a30bbdd1aa:resolve-conflicts	# lightningd: handle bcli plugins returning fee_floor and feerates parameters.
	812a5a14c0c733404c46778887dde2861015df93:strip=tests/	# plugins/bcli: use the new feerate levels, and the floor.
	...
	c45eb62b57851395b4c2c444b1bf7d869de3fa6d:resolve-conflicts	# lightningd: create small hsm_sync_req() helper for hsm queries.
...
#	7e5146ab0cd05428688632fcb602a4edc59d3020	# common/channel_type: routines to set known variants, set scid_alias.
...
#	b42984afe15fb9ab936e1dc5f2b0290c4152865d	# pytest: Reproduce #6143
	...
	650443e4d50eb55f1fc1fd96b388d78e8dd80c64:resolve-conflicts	# ld: Add a couple of logging statements when forwarding
