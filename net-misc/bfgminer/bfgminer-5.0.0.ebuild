...
REQUIRED_USE='
	...
	sha256d? ( || ( antminer avalon avalonmm bfx bifury bitforce bfsb bigpic bitfury cointerra cpumining drillbit dualminer hashbuster hashbuster2 hashfast icarus jingtian klondike littlefury metabank modminer nanofury opencl proxy proxy_getwork proxy_stratum rockminer twinfury x6500 ztex ) )
	twinfury? ( bitfury )
	unicode? ( ncurses )
